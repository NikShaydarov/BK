...
//даже если он покинул страницу и вернулся обратно. Это удобно для сохранения и восстановления введенных данных.
  ...
  // Проверяем ошибки.
//В итоге, данный код обрабатывает ввод в поле "name", проверяет его наличие и соответствие формату, устанавливает соответствующие cookie 
//для управления состоянием ошибок и сохраняет введенное значение в cookie на длительный срок или очищает cookie в случае успешного ввода.
  $errors = FALSE;
